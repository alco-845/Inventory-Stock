...
public class ActivityCetak2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        faktur = getIntent().getStringExtra("fakturjual") ;

        if(TextUtils.isEmpty(faktur)){
            Intent i = new Intent(this, ActivityMenuUtama.class) ;
            i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP) ;
            Toast.makeText(this, "Faktur Kosong", Toast.LENGTH_SHORT).show();
            startActivity(i);
        }
    ...
    public void setPreview(){
        ...
        Cursor bayar = db.sq(Query.selectwhere("qjual")+Query.sWhere("fakturjual",faktur)) ;
        bayar.moveToNext() ;
        Cursor penj = db.sq(Query.selectwhere("qcartjual")+Query.sWhere("fakturjual",faktur)) ;

        String toko = Function.getString(identitas,"nama") ;
        String alamat = Function.getString(identitas,"alamat") ;
...
//                pembayaran+"\n"+
        ...
        while(penj.moveToNext()){
            ...
            String jumlah = Function.getString(penj,"jumlahjual") ;

            body+=  barang+"\n"+
                    Function.setRight(Function.removeE(jumlah)+" Item")+"\n" ;
            view+=  barang+"\n"+
                    setRight(Function.removeE(jumlah)+" Item")+"\n" ;
        }
        Function.setText(v,R.id.tbarang,view) ;
        body+=Function.getStrip() ;

        String caption =  Function.getString(identitas,"cap1") ;
        String caption2 = Function.getString(identitas,"cap2") ;
        String caption3 = Function.getString(identitas,"cap3") ; Function.setText(v,R.id.tCaption,caption+"\n"+caption2+"\n"+caption3) ;
    ...
    public void cari(View view){
        Intent i = new Intent(this,ActivityCetakCari2.class) ;
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(ActivityCetak2.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
